...
urlpatterns = [
    ...
    path("<uuid:recipe_id>/ingredients/create/", views.ingredient_create, name="ingredient_create"),
    path("ingredients/<uuid:ingredient_id>/delete/", views.ingredient_delete, name="ingredient_delete"),
